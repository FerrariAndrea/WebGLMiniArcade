...
function exstrapolateArrays(model){
    ...
    var textc = [];
    for(var i=0;i<model.texcoords.length;i+=3){
        textc.push([
            model.texcoords[i],
            model.texcoords[i+1]
        ]);
    ...
    for(var i=0;i<model.triangles.length;i++){
        ...
        if(textc.length>0){
                //texture        
                ris.texcoords.push(textc[actualT.vindices[0]][0]);
                ris.texcoords.push(textc[actualT.vindices[0]][1]);
                
                ris.texcoords.push(textc[actualT.vindices[1]][0]);
                ris.texcoords.push(textc[actualT.vindices[1]][1]);

                ris.texcoords.push(textc[actualT.vindices[2]][0]);
                ris.texcoords.push(textc[actualT.vindices[2]][1]);
        }
