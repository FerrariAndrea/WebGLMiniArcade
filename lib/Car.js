class Car{
    ...
    constructor(objs,x=0,y=-1.0,z=0,o=-90){
            ...
            this.fari_sup_dest = [0.0,0.46,-1.0];
    ...
    draw(gl,programInfo){
        ...
        faro_dst = transformVector3(tempM_fari,this.fari_sup_dest);
      ...
      enableKeyboard(enable){
       ...
       doKeyDown(e){
        ...
        setLigths(programInfo){
            ...
            if(this.lightWorldMatrix.ad===undefined || this.lightWorldMatrix.as===undefined){
                webglUtils.setUniforms(programInfo, {
                    ...
                    u_shininess_A:150,
                    u_lightColor_A: [0.2, 1.0, 0.2, 1.0],
                    u_specularColor_A : [0.0, 0.2, 0.0],
                ...
                //   console.log("u_innerLimit_A",  Math.cos(degToRad(this.fieldOfView_A / 2 - 10)));                  
                //   console.log("u_outerLimit_A",  Math.cos(degToRad(this.fieldOfView_A / 2)));
            }else{
                webglUtils.setUniforms(programInfo, {
                    u_lightWorldPosition_AD:this.lightWorldMatrix.src_ad,                  
                    u_lightWorldPosition_AS:this.lightWorldMatrix.src_as,  
        ...
        drawFrustum(gl,cameraMatrix,colorProgramInfo,projectionMatrix,cubeLinesBufferInfo){
            ...
            const lightProjectionMatrix = this.perspective
            ? m4.perspective(
            ...
            // infinity
            const mat_d = m4.multiply(this.lightWorldMatrix.ad, m4.inverse(lightProjectionMatrix));        
            ...
            webglUtils.drawBufferInfo(gl, cubeLinesBufferInfo, gl.LINES);
             ...
             // to represent the texture is being projected to
             // infinity
             const mat_s = m4.multiply(this.lightWorldMatrix.as, m4.inverse(lightProjectionMatrix));        
             // Set the uniforms we just computed
             webglUtils.setUniforms(colorProgramInfo, {
               u_color: [0, 0, 1, 1],
               u_view: viewMatrix,
            ...
            //  // to represent the texture is being projected to
            //  // infinity
            //  const mat_s_sup = m4.multiply(this.lightWorldMatrix.as_sup, m4.inverse(lightProjectionMatrix));        
            //  // Set the uniforms we just computed
            //  webglUtils.setUniforms(colorProgramInfo, {
            //    u_color: [0, 1, 0, 1],
            //    u_view: viewMatrix,
