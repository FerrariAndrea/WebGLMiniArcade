class Car{
    ...
    constructor(obj_car,obj_wheel,x=0,y=0,z=0,o=0){
            //binds
            ...
            this.posRel_faro_ad={};
            this.posRel_faro_ad.x=0.644;
            this.posRel_faro_ad.y=0.653;
            this.posRel_faro_ad.z=-1.668;
            this.actualOrientation_faro_ad=[5.0,8.0,6.0];
            //---------------------------------------------------fisica auto
    ...
    draw(gl,programInfo){
        this.CarDoStep();//questo andrebbe spostato 
        //sposto l'auto
        ...
        this.obj_real_wheel.translate(this.posRel_ruote_posteriori.x,this.posRel_ruote_posteriori.y,this.posRel_ruote_posteriori.z);
        ...
        // ruota anteriore D
        this.obj_real_wheel.mMatrix=m4.copy(this.objCar.mMatrix);
        this.obj_real_wheel.translate(this.posRel_ruote_ateriori.x,this.posRel_ruote_ateriori.y,this.posRel_ruote_ateriori.z);
    ...
    CarDoStep(){
        ...
        this.pz+=this.vz;
        //------------------------------------------
        //rotazione faro anteriore destro
        // var new_x =this.actualOrientation_faro_ad[0]*Math.cos(this.facing) - this.actualOrientation_faro_ad[1]*Math.sin(this.facing);
        // var new_y=this.actualOrientation_faro_ad[0]*Math.sin(this.facing) + this.actualOrientation_faro_ad[1]*Math.cos(this.facing);
        // this.actualOrientation_faro_ad=[new_x,new_y,  this.actualOrientation_faro_ad[2]];
       ...
       doKeyDown(e){
        ...
        setLigths(programInfo){
            webglUtils.setUniforms(programInfo, {
                u_lightWorldPosition_AD:[this.px+this.posRel_faro_ad.x,this.py+this.posRel_faro_ad.y, this.pz+this.posRel_faro_ad.z],      
                //u_color_A: [1.0, 0.0, 0.0], 
                u_shininess_A:500,
                u_lightColor_A: [1.0, 1.0, 1.0, 1.0],
                u_specularColor_A : [1.0, 1.0, 1.0],
                u_lightDirection_A: [this.px+this.posRel_faro_ad.x,this.py+this.posRel_faro_ad.y-1,this.pz+this.posRel_faro_ad.z],//this.actualOrientation_faro_ad,5
                // u_outerLimit_A: Math.cos(degToRad(80 / 2 - 10)), 
                // u_innerLimit_A: Math.cos(degToRad(80 / 2)),
                u_outerLimit_A:0.9, 
                u_innerLimit_A:0.9
              });
        }
