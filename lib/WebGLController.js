...
class WebGLController{
        ...
        init(){
                ...
                this.settings = {
                        ...
                        targetY:0,
                        targetZ: 2,
                        //setting generali per le luci del mondo (luce da campo)
                        projWidth: 1, //2
                        projHeight:1,//2
                        perspective: true,
                        fieldOfView: 60, //120
                        ...
                        near: 5,
                        shininess: 500,
                        //setting per la diffusione ambientale della luce
                        lightPosition : [-30.0, +20.0, -30.0, 0.0 ],
                        lightAmbient :  [1.0, 0.8, 0.8 , 1.0 ],
        ...
        //console.log("lightWorldMatrix",lightWorldMatrix);
              ...
              const illuminazioneTemp = (specchioMatrix===null ? this.illuminazione : this.illuminazione/4);
              ...
              webglUtils.setUniforms(programInfo, {
                ...
                u_shininess: this.settings.shininess, //riferito alle luci da campo
                ...
                //illuminazione generale (non luce vera, ma luce "ambientale")          
                illuminazione: illuminazioneTemp,     
                lightPosition : this.settings.lightPosition,
                 //in realtà questi 3 valori andrebbero calcolati in base ai valorei dei singoli OBJ
                 //per semplicità li pongo uguali a tutti gli obj quindi il prodotto è statico come segue
                ambientProduct :  this.settings.lightAmbient,
                diffuseProduct : this.settings.lightDiffuse,
                specularProduct : this.settings.lightSpecular,       
                shininess: this.settings.lightShininess,       
