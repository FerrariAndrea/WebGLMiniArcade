...
class WebGLController{
        ...
        init(){
                ...
                // this.o = new Ombre();
                // console.log("this.depthTexture", this.o.init(gl));
                // this.depthTexture =this.o.depthTextures;
                // this.depthFramebuffer=this.o.depthFramebuffers;
                
                // console.log("this.depthFramebuffer", this.o.depthFramebuffers);
        ...
        realRender(cameraMatrix,projectionMatrix,specchioMatrix=null,textureMatrixAlredyCalculated=null){
                ...
                this.drawScene(
                    ...
                    textureMatrix,
                    lightWorldMatrix,
                    this.textureProgramInfo,specchioMatrix);//,this.mMatrix_texture
        ...
        render(){
                ...
                // const eye = [ 
                //         this.settings.radius*Math.sin(this.settings.phi)*Math.cos(this.settings.theta), 
                //         this.settings.radius*Math.sin(this.settings.phi)*Math.sin(this.settings.theta),
                //         this.settings.radius*Math.cos(this.settings.phi)
                //         ];
           
                // var eye = [ 
                //         this.settings.phi*Math.cos(this.settings.theta), 
                //         this.settings.phi*Math.sin(this.settings.theta),
