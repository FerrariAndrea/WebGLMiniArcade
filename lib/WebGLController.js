...
function setUpOmbre(lightWorldMatrix,lightProjectionMatrix,objs,this_){
        ...
        this_.drawScene(
            ...
            m4.identity(),
            lightWorldMatrix,
            this_.colorProgramInfo);//,this_.mMatrix_programInfo
 ...
 function setOmbreMatrix(textureMatrix,lightWorldMatrix,lightProjectionMatrix,objs){
...
//              for(var i=0;i<lightProjectionMatrixs.length;i++){
//                  //console.log(i);
//                  textureMatrix = m4.multiply(textureMatrix, lightProjectionMatrixs[i]);
//                  textureMatrix = m4.multiply( textureMatrix, m4.inverse(lightWorldMatrixs[i]));
//              }
//          }
//      }
...
class WebGLController{
        ...
        render(){
                ...
                setUpOmbre(lightWorldMatrix,lightProjectionMatrix,this.getObjects(),this);                
                ...
                textureMatrix= setOmbreMatrix(textureMatrix,lightWorldMatrix,lightProjectionMatrix,this.getObjects())
                // textureMatrix = m4.multiply(textureMatrix, lightProjectionMatrix);
                // // use the inverse of this world matrix to make
                // // a matrix that will transform other positions
                // // to be relative this this world space.
